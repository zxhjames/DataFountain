'''
Author: your name
Date: 2021-02-25 21:48:11
LastEditTime: 2021-02-26 10:11:39
LastEditors: your name
Description: In User Settings Edit
FilePath: /PyCode/project_demo/Datafountain/Learn/car/code/solution.py
'''
import pandas as pd
...
test[['id', 'forecastVolum']].round(0).astype(int).to_csv('../data/sub.csv', encoding='utf8', index=False)